...
const HELP = "Tap Book a table to choose a date, time, and party size.\n\nUse My bookings to reschedule or cancel. Restaurant owners can open Owner tools with /admin.";
